...
#
#input: one of dhi_input_layer_generator.py output files as sys.argv[1]
...
x_train = x_train.drop("G_rel", axis=1)
x_test = x_test.drop("G_rel", axis=1)
x_val = x_val.drop("G_rel", axis=1)
x_train_post = x_train.drop("E_exc", axis=1)
x_test_post = x_test.drop("E_exc", axis=1)
x_val_post = x_val.drop("E_exc", axis=1)
